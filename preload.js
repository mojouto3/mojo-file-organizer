...
contextBridge.exposeInMainWorld('api', {
  ...
  addSession:      (s)      => ipcRenderer.invoke('add-session', s),
  ...
  scheduleRules:    (opts)   => ipcRenderer.invoke('schedule-rules', opts),
  unscheduleRules:  ()       => ipcRenderer.invoke('unschedule-rules'),
